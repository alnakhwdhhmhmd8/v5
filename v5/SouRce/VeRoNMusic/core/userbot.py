...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("Source_Veron")
                await self.one.join_chat("ToxVe")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("Source_Veron")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("Source_Veron")
                await self.three.join_chat("Source_Veron")
                await self.three.join_chat("Source_Veron")
                await self.three.join_chat("Source_Veron")
            except:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Source_Veron")
                await self.four.join_chat("Source_Veron")
                await self.four.join_chat("Source_Veron")
                await self.four.join_chat("Source_Veron")
            except:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("Source_Veron")
                await self.five.join_chat("ToxVe")
                await self.five.join_chat("Source_Veron")
                await self.five.join_chat("Source_Veron")
            except:
                pass
