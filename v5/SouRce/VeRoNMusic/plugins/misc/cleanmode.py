...
from VeRoNMusic.utils.cleanmode import protected_messages
...
from VeRoNMusic.utils.formatters import alpha_to_int
...
@app.on_message(filters.command(["ذيع"], "") & SUDOERS, group=72772)
@app.on_message(filters.command(BROADCAST_COMMAND) & SUDOERS, group=72655772)
@language
