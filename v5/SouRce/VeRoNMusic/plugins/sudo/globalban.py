...
from VeRoNMusic.utils import get_readable_time
...
@app.on_message(filters.command(["حظرر عام"], "") & SUDOERS, group=4)
...
@app.on_message(filters.command(["فك حظر عام"], "") & SUDOERS, group=32884)
...
@app.on_message(filters.command(["الممنوعين عام"], "") & SUDOERS, group=4)
