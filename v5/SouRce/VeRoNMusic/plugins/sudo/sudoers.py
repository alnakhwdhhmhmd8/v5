...
from VeRoNMusic.utils.database import add_sudo, remove_sudo
...
@app.on_message(filters.command(["ررفع عام"], "") & SUDOERS, group=35444)
...
@app.on_message(filters.command(["تنزييل عام"], "") & SUDOERS, group=4784)
...
@app.on_message(filters.command(["المرفوعين عام"], "") & SUDOERS, group=65894)
