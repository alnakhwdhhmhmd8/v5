...
from VeRoNMusic.utils.database.memorydatabase import get_video_limit
from VeRoNMusic.utils.formatters import convert_bytes

VARS_COMMAND = get_command("VARS_COMMAND")


@app.on_message(filters.command(["فحص السيرفر"], "") & SUDOERS, group=345444)
