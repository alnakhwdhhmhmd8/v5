...
tgxxt = [
"تاريخ انشاء سورس فيࢪون 2020"
        ]
@app.on_message(filters.command(["انشاء السورس","انشاء سورس"], ""), group=73)
...
@app.on_message(filters.command(["خديجه"], ""), group=253)
...
@app.on_message(filters.command(["ههه"], ""), group=673)
...
nhtxt = [
"اوعا ع الجمدان بقى حبيبتي وشغل عالي 🙈❤️"
        ]
...
@app.on_message(filters.command(["هالو"], ""), group=200973)
...
kjjhtxt = [
"الله يرحم ابوك كان بيشرب الشربه بخرطوم الغساله 😂🙂"
        ]
