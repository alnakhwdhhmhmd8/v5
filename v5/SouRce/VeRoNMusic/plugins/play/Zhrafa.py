...
@app.on_message(filters.command(["زخرفه"], ""), group=7511111478512369754128793)
async def zahrafa(c: Client, m: Message):
    ask = await app.ask(m.chat.id, "ارسـل لـي الزخـرفه..", timeout=300)
    text = ask.text
    if len(text) > 200:
        await m.reply_text("لا يمكنك تشكيل أكثر من 200 حرفاً، يرجى المحاولة مرة أخرى!\n")
        return
    ...
    zhrf12 = re.sub('a', "𝖆", zhrf12)
    zhrf12 = re.sub('A', "𝕬", zhrf12)
    zhrf12 = re.sub("b", "𝖇", zhrf12)
    zhrf12 = re.sub("B", "𝖁", zhrf12)
    zhrf12 = re.sub("c", "𝖈", zhrf12)
    zhrf12 = re.sub("C", "𝕮", zhrf12)
    zhrf12 = re.sub("d", "𝖉", zhrf12)
    zhrf12 = re.sub("D", "𝕱", zhrf12)
    zhrf12 = re.sub("e", "𝖊", zhrf12)
    zhrf12 = re.sub("E", "𝕰", zhrf12)
    zhrf12 = re.sub("f", "𝖋", zhrf12)
    zhrf12 = re.sub("F", "𝕱", zhrf12)
    zhrf12 = re.sub("g", "𝖌", zhrf12)
    zhrf12 = re.sub("G", "𝕲", zhrf12)
    zhrf12 = re.sub("h", "𝖍", zhrf12)
    zhrf12 = re.sub("H", "𝕳", zhrf12)
    zhrf12 = re.sub("i", "𝖎", zhrf12)
    zhrf12 = re.sub("I", "𝕴", zhrf12)
    zhrf12 = re.sub("j", "𝖏", zhrf12)
    zhrf12 = re.sub("J", "𝕵", zhrf12)
    zhrf12 = re.sub("k", "𝖐", zhrf12)
    zhrf12 = re.sub("K", "𝕶", zhrf12)
    zhrf12 = re.sub("l", "𝖑", zhrf12)
    zhrf12 = re.sub("L", "𝕷", zhrf12)
    zhrf12 = re.sub("m", "𝕸", zhrf12)
    zhrf12 = re.sub("M", "𝖒", zhrf12)
    zhrf12 = re.sub("n", "𝖓", zhrf12)
    zhrf12 = re.sub("N", "𝕹", zhrf12)
    zhrf12 = re.sub("o", "𝖔", zhrf12)
    zhrf12 = re.sub("O", "𝕺", zhrf12)
    zhrf12 = re.sub("p", "𝖕", zhrf12)
    zhrf12 = re.sub("P", "𝕻", zhrf12)
    zhrf12 = re.sub("q", "𝖖", zhrf12)
    zhrf12 = re.sub("Q", "𝕼", zhrf12)
    zhrf12 = re.sub("r", "𝖗", zhrf12)
    zhrf12 = re.sub("R", "𝕽", zhrf12)
    zhrf12 = re.sub("s", "𝖘", zhrf12)
    zhrf12 = re.sub("S", "𝕾", zhrf12)
    zhrf12 = re.sub("t", "𝖙", zhrf12)
    zhrf12 = re.sub("T", "𝕿", zhrf12)
    zhrf12 = re.sub("u", "𝖚", zhrf12)
    zhrf12 = re.sub("U", "𝖀", zhrf12)
    zhrf12 = re.sub("v", "𝖈", zhrf12)
    zhrf12 = re.sub("V", "𝕮", zhrf12)
    zhrf12 = re.sub("w", "𝖜", zhrf12)
    zhrf12 = re.sub("W", "𝖂", zhrf12)
    zhrf12 = re.sub("x", "𝖝", zhrf12)
    zhrf12 = re.sub("X", "𝖃", zhrf12)
    zhrf12 = re.sub("y", "𝖞", zhrf12)
    zhrf12 = re.sub("Y", "𝖄", zhrf12)
    zhrf12 = re.sub("z", "𝖅", zhrf12)
    zhrf12 = re.sub("Z", "𝖟", zhrf12)
    ...
    zhrf13 = re.sub('A', "ꪉ", zhrf13)
    zhrf13 = re.sub("b", "ꪉ", zhrf13)
    ...
    Text_Zhrfa = "1- <code>" + zhrf + random.choice(EmojeS) \
                 + "</code>\n\n<code> " + zhrf2 + random.choice(EmojeS) \
                 + "</code>\n\n<code> " + zhrf3 + random.choice(EmojeS) \
                 + "</code>\n\n<code> " + zhrf4 + random.choice(EmojeS) \
                 + "</code>\n\n<code> " + zhrf5 + random.choice(EmojeS) \
                 + "</code>\n\n<code> " + zhrf6 + random.choice(EmojeS) \
                 + "</code>\n\n<code> " + zhrf7 + random.choice(EmojeS) \
                 + "</code>\n\n<code> " + zhrf8 + random.choice(Emoje) \
                 + "</code>\n\n<code> " + zhrf9 + random.choice(Emoje) \
                 + "</code>\n\n<code> " + zhrf10 + random.choice(Emoje) \
                 + "</code>\n\n<code> " + zhrf11 + random.choice(Emoje) \
                 + "</code>\n\n<code> " + zhrf12 + random.choice(Emoje) \
                 + "</code>\n\n<code> " + zhrf13 + random.choice(Emoje) \
                 + "</code>\n\n<code> " + zhrf14 + random.choice(Emoje) \
                 + "</code>\n\n<code> " + zhrf15 + random.choice(Emoje) \
                 + "</code>\n\n<code> " + zhrf16 + random.choice(Emoje) \
                 + "</code>\n\n<code> " + zhrf5 + random.choice(Emoje)
    Text_Zhrfa = Text_Zhrfa + "<code>\n\n اضغـط لـلنـسـخ"
