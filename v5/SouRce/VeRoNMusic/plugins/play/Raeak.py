...
RAEAK = ["فاجره","حلوه","فخامه","جميله","رايقه","جميله","يععععع","وحشه","مش حلوه","حلوه يا عم","خليك بيها","حبتها","غيرها يسطا"]

@app.on_message(filters.command(["رايك بصورتي","رايك ف صورتي"], ""), group=7529)
