...
from VeRoNMusic.utils.database import get_served_chats, get_served_users, get_sudoers
...
@app.on_message(filters.command(["اعلام", "علم","• اعلام •"], ""), group=101237782131)
...
@app.on_message(filters.command(["لاعبين", "لاعب","• لاعبين •"], ""), group=9827065)
...
@app.on_message(filters.command(["افلام", "فيلم","• افلام •"], ""), group=76006953)
...
@app.on_message(filters.text, group=7562065)
...
@app.on_message(filters.command(["لغز", "فزوره","• لغز •"], ""), group=6456565)
...
@app.on_message(filters.command(["مختلف", "اختلاف","الاختلاف","• مختلف •"], ""), group=6565065)
